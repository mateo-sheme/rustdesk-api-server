...
class RustDesDevice(models.Model):
    ...
    hostname = models.CharField(verbose_name='CPU name', max_length=20)
    ...
    create_time = models.DateTimeField(verbose_name='Equipment registration time', auto_now_add=True)
    update_time = models.DateTimeField(verbose_name='Equipment update time', auto_now=True, blank=True)
